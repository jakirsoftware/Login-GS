...
// whatsapp https://wa.me/3224083545

function checkLogin(username, password) {
  var url = '////// Paster Your Google Sheet Complete URL///////';
...
function AddRecord(usernamee, passwordd, email, phone) {
  var url = 'https://docs.google.com/spreadsheets/d/19vxRCmYJ7aF0NRo2jdDiS6ZoP_mMv4SMvn2jCRGhpG8/edit#gid=0';
  var ss= SpreadsheetApp.openByUrl(url);
  var webAppSheet = ss.getSheetByName("DATA");
